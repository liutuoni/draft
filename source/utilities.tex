...
\begin{itemize}
\item
\tcode{negation<is_same<remove_cvref_t<U0>, tuple>>}
if \tcode{sizeof...(Types)} is 1;
\item
otherwise,
\tcode{bool_constant<!is_same_v<remove_cvref_t<U0>, allocator_arg_t> ||
is_-\newline{}same_v<remove_cvref_t<T0>, allocator_arg_t>>}
...
shall denote a cv-unqualified non-reference type
